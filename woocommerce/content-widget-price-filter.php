...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
			...
			<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-default', pediland_form_class( 'button-size-sm' ) ) ); ?>"><?php echo esc_html__( 'Filter', 'woocommerce' ); ?></button>
