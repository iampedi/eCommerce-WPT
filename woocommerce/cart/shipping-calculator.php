...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" id="shipping-calculator-form" style="display:none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="<?php echo esc_attr( pediland_form_class( 'button-default', pediland_form_class( 'button-size-sm' ) ) ); ?>"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
