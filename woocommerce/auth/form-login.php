...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-default', 'button-large button-primary wc-auth-login-button ' . pediland_form_class( 'button-size-lg' ) ) ); ?>" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
