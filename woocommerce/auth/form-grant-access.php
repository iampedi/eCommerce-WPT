...
<p class="wc-auth-actions">
	<a href="<?php echo esc_url( $granted_url ); ?>" class="<?php echo esc_attr( pediland_form_class( 'button-payment-primary', 'button button-primary wc-auth-approve ' . pediland_form_class( 'button-size-md' ) ) ); ?>"><?php esc_html_e( 'Approve', 'woocommerce' ); ?></a>
	<a href="<?php echo esc_url( $return_url ); ?>" class="<?php echo esc_attr( pediland_form_class( 'button-outline-size-md', 'button wc-auth-deny' ) ); ?>"><?php esc_html_e( 'Deny', 'woocommerce' ); ?></a>
</p>
