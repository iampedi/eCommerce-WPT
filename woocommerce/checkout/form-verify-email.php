...
<form name="checkout" method="post" class="woocommerce-form woocommerce-verify-email" action="<?php echo esc_url( $verify_url ); ?>">
	...
	<p class="form-row">
		<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-default', 'woocommerce-button ' . pediland_form_class( 'button-size-md' ) ) ); ?>" name="verify" value="1">
