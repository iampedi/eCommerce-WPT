...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-default', 'woocommerce-Button ' . pediland_form_class( 'button-size-md' ) ) ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
