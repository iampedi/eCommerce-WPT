	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-payment-primary', 'woocommerce-Button woocommerce-Button--alt ' . pediland_form_class( 'button-size-md' ) ) ); ?>" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></button>
