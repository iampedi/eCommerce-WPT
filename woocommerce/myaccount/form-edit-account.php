...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p>
		...
		<button type="submit" class="<?php echo esc_attr( pediland_form_class( 'button-default', 'woocommerce-Button ' . pediland_form_class( 'button-size-md' ) ) ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
